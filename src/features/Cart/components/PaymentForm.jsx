...
const PaymentForm = () => {
    ...
    const handleCheckout = () => {
        // Xử lý thanh toán khi nhấn vào nút Mua ngay
    ...
    return (
        <Box className={classes.paymentForm}>
            <Box className={classes.paymentForm_originalPrice}>
                <Typography variant="caption" gutterBottom style={{ marginRight: '35px' }}>
                    Tạm tính
                </Typography>
            ...
            <Box className={classes.paymentForm_promotionPercent}>
                <Typography variant="caption" gutterBottom style={{ marginRight: '15px' }}>
                    Giảm giá
                </Typography>
                <Typography variant="caption" gutterBottom>
                    - {formatPrice(originalPrice - cartTotal)}
            ...
            <Button className={classes.buyButton} variant="contained" color="primary" onClick={handleCheckout}>
                Mua ngay
            </Button>
        </Box>
    );
